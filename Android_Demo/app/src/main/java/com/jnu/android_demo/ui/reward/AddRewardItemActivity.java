...
public class AddRewardItemActivity extends AppCompatActivity {
    private TextView textView_reward_type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_reward_type = findViewById(R.id.textView_reward_type);
        ...
        findViewById(R.id.button_add_reward_item_ok).setOnClickListener(v -> {
            ...
            String type = textView_reward_type.getText().toString();
            switch (type) {
                case "单次":
    ...
    private void showPopupMenu(View view) {
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            ...
            if (id == R.id.menu_option_once) {
                textView_reward_type.setText("单次");
            } else if (id == R.id.menu_option_repeatedly) {
                textView_reward_type.setText("多次");
            }
            return true;
        });
